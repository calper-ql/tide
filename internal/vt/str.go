...
func (t *State) setColorName(j int, p *string) error {
	// tide: the bound must admit the special DefaultFG/DefaultBG/
	// DefaultCursor indices (1<<24 ..); upstream's 1<<24 cap silently
	// rejected OSC 11/12 default-color overrides.
